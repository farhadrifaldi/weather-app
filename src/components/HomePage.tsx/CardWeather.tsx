...
import { FaRegStar, FaStar, FaTrash, FaWind } from "react-icons/fa";
...
export function CardWeather({ weather, location, date, showFavoriteBtn = false, showDeleteBtn = false, cityId, loading = false }: props): ReactElement {
